  ...
  describe "properties" do
    ...
    describe "api_token_plain" do
      ...
      it "should support valid hexstrings" do
        ...
        expect { described_class.new(:name => "nobody", :api_token_plain => value) }.to_not raise_error
      end
      ...
      %w[ 51a8b1dd95bc76b1a2869356c043e8b
        ...
        it "should reject hexstrings of invalid length" do
          expect { described_class.new(:name => "nobody", :api_token_plain => value) }.to raise_error(Puppet::ResourceError, /is not a 32char hex string/)
        end
      end
    end #api_token_plain
